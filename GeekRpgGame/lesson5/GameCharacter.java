...
public abstract class GameCharacter implements MapElement {
    ...
    // Проверка соответствия оружия и типа персонажа.
    public void checkWeapon(GameCharacter gameCharacter) {
        if (gameCharacter.weapon.getArrows() == weapon.getArrows() ) type = GameCharacter.Type.RANGED;
        if (gameCharacter.weapon.getBlade() == weapon.getBlade()) type = GameCharacter.Type.MELEE;
    }
