...
//        // - Сделать пачку ботов. Не работает. Объясните пожалуйста мою ошибку.
//        // Весь код, который касается данного задания,
//        // написан и закомментирован в классах GameController.java
//        // и WorldRenderer.java.
//        for (int i = 0; i < gc.getPoolMonster().size(); i++) {
//            drawables[gc.getHero().getCellY()].add(gc.getPoolMonster().get(i));
//        }
